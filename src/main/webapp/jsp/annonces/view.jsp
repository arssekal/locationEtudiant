...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
                ...
                <div class="contact-section fade-in">
                    ...
                    <div class="contact-grid">
                        <div class="contact-box">
                            ...
                            <div class="contact-value">${annonce.proprietaire.nom}</div>
                        </div>
                        ...
                        <div class="contact-box">
                            ...
                            <c:choose>
                                <c:when test="${not empty sessionScope.utilisateur}">
                                    ...
                                    <a href="${pageContext.request.contextPath}/message?action=compose&to=${annonce.proprietaire.id}&annonce=${annonce.id}"
                                       class="contact-btn"
            ...
            <c:if test="${not empty sessionScope.utilisateur && sessionScope.utilisateur.id == annonce.proprietaire.id}">
